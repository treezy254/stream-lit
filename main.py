...
def main():
    ...
    page = st.sidebar.radio("Choose a Page", ["Model Selector", "Interactive Modelfile Creator", "Chat Interface", 
                                              "Set Ollama API Url", "LiteLLM Proxy", "Public Endpoint", "Downloading Models"])
