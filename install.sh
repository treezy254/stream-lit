...
install_python_requirements() {
    local required_packages=("streamlit" "orjson" "uvicorn" "litellm[proxy]" "requests" "flask" "pyautogen" "connexion[flask]" "flask-cloudflared" "httpx" "litellm" "huggingface_hub" "asyncio" "Pyyaml" "httpx" "APScheduler" "cryptography" "pycloudflared" "numpy==1.24.4" "sentencepiece==0.1.98" "transformers>=4.34.0" "gguf>=0.1.0" "protobuf>=4.21.0" "torch==2.1.1" "transformers==4.35.2")
